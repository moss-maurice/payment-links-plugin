<!--
    Please, place this file as "/assets/plugins/sberbank/templates/custom/form.php"
-->
<?php global $modx; ?>
...
<form id="<?= $pluginContainer; ?>" class="sberbank form <?= $placeholder; ?>" method="post" action="<?= $action; ?>">
    ...
    <div class="price back-place">
        <input type="text" name="amount" value="<?= $amount; ?>" required disabled placeholder="Размер оплаты" />
    </div>
    <?php endif; ?>
